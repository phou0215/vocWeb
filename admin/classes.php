                      ...
                      <div class="row">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="page-header">
                                  <h2 class="pageheader-title">분류리스트관리</h2>
                                  <div class="page-breadcrumb">
                                      <nav aria-label="breadcrumb" style='margin-bottom:2px;'>
                                          <ol class="breadcrumb">
                                              ...
                                              <li class="breadcrumb-item active" aria-current="page">분류리스트관리</li>
                                          </ol>
                                      </nav>
                                      <div class="float-left" style="margin-bottom:5px">
                                          <button class="btn btn-info" onClick="moveClassAd()">추가</button>
                                      </div>
                                      <div class="float-right" style="margin-bottom:5px">
                                          <button class='btn btn-secondary' onclick='removeClassData()'>삭제</a>
                                      </div>
                                      <div class="float-right" style="margin-bottom:5px">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="card">
                                  <div class="card-body">
                                        ...
                                        <button class="btn btn-primary search-btn" type="button" onclick='searchClass();'>검색</button>
                                  </div>
                              </div>
                          </div>
                          <!-- ============================================================== -->
                                            ...
                                            <div class='card-body'>
                                                <div class='row align-items-center'>
                                                    <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
                                                        ...
                                                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
                                                            <div class='float-left' style='margin-bottom:5px'>
                                                                <button class='btn check' onclick='setChart(".$row['no'].",".$row['flag'].")' checked='".$row['flag']."'> 적용</button>
                                                            </div>
