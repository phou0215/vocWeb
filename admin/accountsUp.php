                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">사용자 정보 변경</h2>
                                    <p class="pageheader-text"></p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="/voc/index.php" class="breadcrumb-link">메인화면</a></li>
                                                <li class="breadcrumb-item"><a href="/voc/admin/accounts.php" class="breadcrumb-link">사용자관리</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">사용자 정보 변경</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-left:7px;padding-right:7px;">
                                <div class="card">
                                    <h5 class="card-header">사용자 정보</h5>
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/updateUserData.php?" method="post" onsubmit='return userInfoCheck();'>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">사용승인 설정*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">관리자 권한 설정*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                            ...
                                            <div class="form-group row text-right">
                                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                    <button type="submit" class="btn btn-space btn-primary">업데이트</button>
                                                    <button type="button" class="btn btn-space btn-secondary" onclick="window.location='/voc/admin/accounts.php';">취소</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
