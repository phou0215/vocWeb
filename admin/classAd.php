                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-left:7px;padding-right:7px;">
                                <div class="card">
                                    <h5 class="card-header">분류정보입력</h5>
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/addClassData.php" method="post" onsubmit='return classInfoCheck();'>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">카테고리명*</label>
                                            ...
                                            <div class="form-group row text-right">
                                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                    ...
                                                    <button type="button" class="btn btn-space btn-secondary" onclick="window.location='/voc/admin/classes.php';">취소</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
