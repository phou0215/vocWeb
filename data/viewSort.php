<?php
    ...
    $sql = "SELECT * FROM voc_tot_data WHERE issueId = '".$issueId."'";
    ...
    if($row_num == 0){
      echo "
          <script>
            alert('해당 이슈번호가 없습니다.'".(String)$row_num.");
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">VOC 단말조치 상세내용</h2>
                                    <p class="pageheader-text"></p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="/voc/index.php" class="breadcrumb-link">메인화면</a></li>
                                                <li class="breadcrumb-item"><a href="/voc/data/sort.php" class="breadcrumb-link">VOC 단말조치</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">VOC 단말조치 상세내용</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-left:7px;padding-right:7px;">
                                <div class="card">
                                    <h5 class="card-header">VOC 상세내용</h5>
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/addDeviceData.php" method="post" onsubmit='return infoCheck();'>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Issue Id</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['issueId'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">제조사</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['manu'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">모델명1</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['model'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">모델명2</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['model2'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">단말기출시일</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['devLaunchDate'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">단말기코드</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['devCode'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">접수일</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['regiDate'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">접수시간</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['regiTime'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">VOC접수번호</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['vocRecieve'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">서비스변경일자</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['changeDate'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">메모내용</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <textarea rows="5" class="form-control" readonly><?php echo $row['memo'];?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">메모분류</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['class1'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">추출단어</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <textarea rows="3" class="form-control" readonly><?php echo $row['extractWord'];?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">업데이트유무</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['updateFlag'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">해외로밍유무</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['roamFlag'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">소프트웨어버전</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['swVer'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">네트워크본부</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['netHead'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">운용사</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['manageCo'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">등록일</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['receiveDate'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">시/도</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['state'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">군구명</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['district'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">요금제코드명</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['planCode'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">User Agent</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['userAgent'];?>>
                                                </div>
                                            </div>
                                            <!-- 버튼 영역 -->
