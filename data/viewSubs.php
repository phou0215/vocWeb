<?php
    ...
    $sql = "SELECT * FROM voc_subscriber WHERE uniqueId = '".$issueId."'";
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">가입자 정보 상세내용</h2>
                                    <p class="pageheader-text"></p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="/voc/index.php" class="breadcrumb-link">메인화면</a></li>
                                                <li class="breadcrumb-item"><a href="/voc/data/subscribe.php" class="breadcrumb-link">가입자 정보</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">가입자 정보 상세내용</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-left:7px;padding-right:7px;">
                                <div class="card">
                                    <h5 class="card-header">가입자 상세내용</h5>
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/addDeviceData.php" method="post" onsubmit='return infoCheck();'>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Unique Id</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['uniqueId'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">추출일</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['subsDate'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">HDV 가입자 수</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['subsHDV'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">LTE 가입자 수</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['subsLTE'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">5G 가입자 수</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['subs5G'];?>>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">총 가입자수</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" class="form-control" readonly value=<?php echo $row['numSubs'];?>>
                                                </div>
                                            </div>
                                            <!-- 버튼 영역 -->
