<?php
    ...
    if($flag == "N" && $dateFlag == "N"){
        $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
    ...
    //////////////////////////////////////////////////////////Term search(date condition)//////////////////////////////////////////////////////
      ...
      $search_type = "term";
      if($date_type == "0"){
        $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE regiDate <= '".$endDate."' ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
      ...
      ///////only start date ///////
        ...
        $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE regiDate BETWEEN '".$startDate."' AND '".$today."' ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
      ...
      ///////both start date ///////
        ...
        $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE regiDate BETWEEN '".$startDate."' AND '".$endDate."' ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
    ...
    //////////////////////////////////////////////////////////keyword search(keyword condition)//////////////////////////////////////////////////////
        ...
        //Single Search Type
          ...
          if($selection == 'memo'){
              ...
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE ".$selection." LIKE '%".$keyword."%' ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
              ///////////Excel download variables////////////
        ...
        //Multi Search Type
            ...
            if($selection_2 == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (".$selection." LIKE '".$keyword."%') AND (".$selection_2." LIKE '%".$keyword_2."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
              ///////////Excel download variables////////////
    ...
    //////////////////////////////////////////////////////////complex search(date and keyword condition)//////////////////////////////////////////////////////
        ...
        if($date_type == 0){
          ...
          if($selectType == "0"){
            # memo내용 검색인 경우
            if($selection == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate <= '".$endDate."') AND (".$selection." LIKE '%".$keyword."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
          ...
          //Multi Search Type
            ...
            if($selection_2 == 'memo'){
              # memo내용 검색이 keyword2애 없는 경우
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate <= '".$endDate."') AND (".$selection." LIKE '".$keyword."%') AND (".$selection_2." LIKE '%".$keyword_2."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
        ...
        ///////date_type 1  complex case///////
          ...
          if($selectType == "0"){
            # memo내용 검색인 경우
            if($selection == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate BETWEEN '".$startDate."' AND '".$today."') AND (".$selection." LIKE '%".$keyword."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
          ...
          ///////multi search type ///////
            ...
            # memo내용 검색이 keyword2에 있는 경우
            if($selection_2 == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate BETWEEN '".$startDate."' AND '".$today."') AND (".$selection." LIKE '".$keyword."%') AND (".$selection_2." LIKE '%".$keyword_2."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
        ...
        ///////date_type 2  complex case///////
          ...
          if($selectType == "0"){
            # memo내용 검색인 경우
            if($selection == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate BETWEEN '".$startDate."' AND '".$endDate."') AND (".$selection." LIKE '%".$keyword."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
          ...
          //Multi Search Type
            ...
            # memo내용 검색이 keyword2에 있는 경우
            if($selection_2 == 'memo'){
              $sql = "SELECT issueId, regiDate, receiveDate, regiTime, model, model2, manu, state, swVer, memo, class1 FROM voc_tot_data WHERE (regiDate BETWEEN '".$startDate."' AND '".$endDate."') AND (".$selection." LIKE '".$keyword."%') AND (".$selection_2." LIKE '%".$keyword_2."%') ORDER BY regiDate DESC, issueId ASC, model2 DESC LIMIT ".$currentLimit.",".$onePage;
