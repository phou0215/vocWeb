                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">VOC 통품전체 상세내용</h2>
                                    <p class="pageheader-text"></p>
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="/voc/index.php" class="breadcrumb-link">메인화면</a></li>
                                                <li class="breadcrumb-item"><a href="/voc/data/index.php" class="breadcrumb-link">VOC 통품전체</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">VOC 통품전체 상세내용</li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
