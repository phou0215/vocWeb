        ...
        $(function() {
            ...
            if ($('#chartjs_line1').length) {
              ...
              $.ajax({
                                          ...
                                          type:"post",
                                          dataType:"json",
                                          data:{"startDate":startDate, "endDate":endDate, "models":models, "type":type, "keys":keys, "keyword_1":keyword_1, "keyword_2":keyword_2, "keyword_3":keyword_3, "modelType":modelType},
                                          async: false,
