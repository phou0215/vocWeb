<?php
    ...
    if($model_flag == '0'){
      $sql_model = "SELECT * FROM voc_models WHERE flag='1' AND cellType='LTE' ORDER BY focusOn DESC, model ASC";
      $model_type = "voc_models";
    }else{
      $sql_model = "SELECT * FROM voc_models2 WHERE flag='1' AND cellType='LTE' ORDER BY focusOn DESC, model ASC";
...
<head>
    ...
    <title>LTE Rate detail chart</title>
</head>
...
<body>
    ...
    <script type="text/javascript" src="/voc/assets/libs/js/detail/details_LTE_rate.js"></script>
