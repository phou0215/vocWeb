...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">키워드차트</h2>
                            <p class="pageheader-text"></p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="/voc/index.php" class="breadcrumb-link">메인화면</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">키워드차트</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="card">
                      <div id='searchForm' class="card-body" style="padding-right:10px;">
                        ...
                        <ul id="searchList">
                          ...
                          <li>
                            <select id="netType" class="selectpicker" onchange="changeSelect();" style="font-size:10px; margin-left:5px;" data-style="btn-primary">
                          ...
                          <li id='select1'>
                            ...
                            <select id="selectModel_5G" class="selectpicker" style="font-size:10px; margin-left:5px;" data-live-search="true" data-size="6" data-style="btn-primary" data-width="100px">
                            <?php
                                  echo "<option value='total_focus' selected='selected'>5G관심</option>";
                                  echo "<option value='total_hole'>5G전체</option>";
                                  while($row = mysqli_fetch_array($result_model_5G)){
                                    echo "<option value='".$row['model']."'>".substr($row['model'], 0, 50)."</option>";
                                  }
                            ?>
                            </select>
                          </li>
                          <li id='select2' style='display:none;'>
                            ...
                            <select id="selectModel_LTE" class="selectpicker" style="font-size:10px; margin-left:5px; display:none;" data-live-search="true" data-size="6" data-style="btn-primary" data-width="100px">
                            <?php
                                  echo "<option value='total_focus' selected='selected'>LTE관심</option>";
                                  echo "<option value='total_hole'>LTE전체</option>";
                          ...
                          <li>
                            <input id="selectKeys" type="text" placeholder="검색어 추가" value='' style="height:41px; width:150px;">
                          </li>
                          <li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 카테고리 VOC건수</h4>
                          <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 카테고리 Rate</h4>
                          <div class="card-body">
                            <canvas id="chartjs_line2" height="60"></canvas>
                          </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>시간대별 VOC건수</h4>
                          <div class="card-body">
                            <canvas id="chartjs_bar2" height="60"></canvas>
                          </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>키워드 연관 Top20</h4>
                            <div class="card-body">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                      <div class="card">
                        <h5 class="card-header" style='color:#4656e9;'>지역별 현황</h5>
                        <div id=table_1 class="card-body">
                        </div>
                      </div>
                    </div>
                ...
                <!-- <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 모델 가입자 수</h4>
                          <div class="card-body">
                            <canvas id="chartjs_bar1" height="60"></canvas>
                          </div>
                        </div>
                ...
                <!-- ============================ fifth chart row Total VOC and Term Rate ============================ -->
                <!-- <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>모델 이전 기간 상관관계 지수</h4>
                            <div class="card-body">
                                <canvas id="chartjs_bar7" height="160px"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>제조사 이전 기간 상관관계 지수</h4>
                            <div class="card-body">
                                <canvas id="chartjs_bar8" height="160px"></canvas>
                            </div>
                        </div>
                    </div>
                </div> -->
    ...
    <script type="text/javascript" src="/voc/assets/libs/js/keyword_chart.js"></script>
