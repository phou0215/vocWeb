...
<body>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                      ...
                      <div id='searchForm' class="card-body" style="padding-right:10px;">
                        ...
                        <ul id="searchList">
                          ...
                          <li>
                            ...
                            <select id="selectModel" class="selectpicker" style="font-size:11px; margin-left:5px;" multiple data-live-search="true" data-size="6" data-max-options="5" data-style="btn-primary" data-width="100px">
                              <?php
                          ...
                          <li>
                            <select id="selectKey" class="selectpicker" style="font-size:11px; margin-left:5px;" multiple onchange="checkKeys();" data-max-options="3" data-style="btn-primary" data-width="100px">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 VOC건수 & 1000명당 비율</h4>
                          <div class="card-body">
                ...
                <!-- ============================ forth chart row Total VOC and Term Rate ============================ -->
                <div class="row">
    ...
    <script type="text/javascript" src="/voc/assets/libs/js/model_chart.js"></script>
