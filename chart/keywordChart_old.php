<?php
    ...
    if($model_flag == '0'){
      $sql_model = "SELECT * FROM voc_models WHERE flag='1' ORDER BY focusOn DESC, model ASC";
      $model_type = "voc_models";
    }else{
      $sql_model = "SELECT * FROM voc_models2 WHERE flag='1' ORDER BY focusOn DESC, model ASC";
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                      ...
                      <div id='searchForm' class="card-body" style="padding-right:10px;">
                        ...
                        <ul id="searchList">
                          ...
                          <li>
                            ...
                            <select id="selectModel" class="selectpicker" style="font-size:11px; margin-left:5px;" data-live-search="true" data-size="6" data-style="btn-primary" data-width="100px">
                              <?php
                          ...
                          <li>
                            <select id="selectManu" class="selectpicker" style="font-size:11px; margin-left:5px;" data-live-search="true" data-size="8" data-style="btn-primary" data-width="100px">
                              <optgroup label="제조사 전체">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 모델 카테고리 VOC건수 & 1000명 비율</h4>
                          <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>일별 제조사 카테고리 VOC건수</h4>
                          <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>모델 키워드 연관 Top20</h4>
                            <div class="card-body">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        <div class="card">
                          <h4 class="card-header" style='color:#4656e9;'>제조사 키워드 연관 Top20</h4>
                            <div class="card-body">
